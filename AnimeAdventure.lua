...
--#region global values
    ...
    getgenv().AutoWomb = data.autowomb
...
--#region Auto Farm Tab
        ...
        autofarmtab:Toggle("Auto Cursed Womb", getgenv().AutoWomb, function(bool)
            getgenv().AutoWomb = bool
            updatejson()
        end)
